...
books = [
    ...
    {
        "id": 5,
        "author": "Carlos Davies",
        "country": "USA",
        "language": "English",
        "title": "Reverting the process",
        "year": 2023,
    }
]
...
users = [
    ...
    {"username": "Bryan", "password": "Bryan", "role": "reader"},
    {"username": "Bell", "password": "Bell", "role": "admin"}
]
...
def admin_required(fn):
    ...
    def wrapper(*args, **kwargs):
        #add code below
        # Check if the user has admin role in the JWT claim
